...
//
// runtimeMinutes is rounded from the archive's runtimeSeconds. The archive has
// not recorded a runtime for every film, so the teaching copy fills the gaps in
// order that a programme total always adds up.
